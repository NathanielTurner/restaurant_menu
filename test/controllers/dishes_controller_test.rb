...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { float: @dish.float, integer: @dish.integer, string: @dish.string, text: @dish.text }
    end
  ...
  test "should update dish" do
    patch :update, id: @dish, dish: { float: @dish.float, integer: @dish.integer, string: @dish.string, text: @dish.text }
    assert_redirected_to dish_path(assigns(:dish))
  end
